...
# Notes from Ryan:
#   1) I like what you got going on here. Making this into a 'widget' and running it in test.py was a great idea
#       this will make integration a lot easier down the line because we'll be able to just add your widget into
#       the greater GUI
#
#   2) I think it has all the write options. 
#       The only addition would be two new fields to the ASSR page (one for carrier frequency and amplitude modulation frequency)
#       but this is minor and can be updated later without breaking stuff. I just wanted to get it down now so I don't forget
#
#   3) I think this is ready for the next step of adding the 'visual' timer/counter with text cues appearing and dissappearing
#       One thing you may want to spend an hour or two doing is cleaning up all of your labels/code organization. While the
#       current labels/organizations work (and I get why you still have large blocks of code commented out - I do the same thing),
#       once we want to start integrating this with Connor's code and whatever code I add, it will be important to have everything
#       as clean as possible. This doesn't have to happen rn, but like (2) I wanted to get it down in writing now so I don't
#       forget hahaha
#
#    4) I just noticed this, but I'm getting these messages when I run test.py:
#               QLayout::addChildLayout: layout "horizontalLayout" already has a parent
#               QLayout::addChildLayout: layout "verticalLayout_5" already has a parent
#
#       looking around I think it has to do with how you delete fields and new options whenever you change the cue type
#       This link may be helpful but it hasn't helped me debug the messages yet so idk: https://www.qtcentre.org/threads/64759-Add-QLayout-to-QWidget-which-already-has-a-layout
#       
#       so after digging I think it may be related to something around line 308 where you have:
#                   self.verticalLayout_5.addLayout(self.horizontalLayout)
# 
#               around line 614 where you have: (I realized that I probably pushed the lines down when I added comments)
#                   self.horizontalLayout_2.addLayout(self.horizontalLayout)
#                   self.horizontalLayout_2.addLayout(self.verticalLayout_5)
#
#        It looks like you're assigning layout boxes to different layout parents. 
#        This may not be a real issue, but think when you go through and clean this file out, you may naturally fix the problem.
#        That's the approach I would take (idk if it's the best approach), but since you will need to clean this up eventually -
#        you may want to leave this issue until you start cleaning everything up (since IDEALLY that'll be soon haha yeaaaa)
